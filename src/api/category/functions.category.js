...
exports.putCategory = exports.postCategory = exports.getByCategory = void 0;
...
exports.postCategory = [
    ...
    express_validator_1.body('description').exists().isString(),
    apiValidator_1.apiValidator,
    apiResponder_1.apiResponder(function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
        var payload, result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    payload = req.body;
                    return [4 /*yield*/, createCategory(payload)];
                case 1:
                    result = _a.sent();
                    return [2 /*return*/, result || []];
            }
    ...
    apiResponder_1.apiResponder(function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    payload = req.body;
                    return [4 /*yield*/, updateCategory(payload)];
                case 1:
                    result = _a.sent();
                    return [2 /*return*/, result || []];
            }
...
var getBy = function (key, value) { return __awaiter(void 0, void 0, void 0, function () {
    var category, query, queryValues;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                queryValues = [];
                if (key && value && Object.keys(category_model_1.getDefaultCategory()).includes(key.trim())) {
...
var createCategory = function (category) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                query = lib_sqlUtils_1.generateInsertQuery("public.\"category\"", category_model_1.getDefaultCategory(), category, true, false);
...
var updateCategory = function (category) { return __awaiter(void 0, void 0, void 0, function () {
    var query, result;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                query = lib_sqlUtils_1.generateUpdateQuery("public.\"category\"", category_model_1.getDefaultCategory(), category, false);
