...
exports.postActor = exports.deleteActor = exports.putActor = exports.getByActor = void 0;
var express_validator_1 = require("express-validator");
var actor_model_1 = require("../../../models/actor.model");
    ...
    apiResponder_1.apiResponder(function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    payload = req.body;
                    return [4 /*yield*/, updateActor(payload)];
                case 1:
                    result = _a.sent();
                    return [2 /*return*/, result || {}];
            }
    ...
    apiResponder_1.apiResponder(function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    payload = req.body;
                    return [4 /*yield*/, removeActor(payload)];
                case 1:
                    result = _a.sent();
                    return [2 /*return*/, result || {}];
            }
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    console.log(actor_model_1.getDefaultActor());
                    return [4 /*yield*/, createActor(payload)];
                case 1:
                    result = _a.sent();
                    return [2 /*return*/, result || {}];
            }
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                queryValues = [];
                if (key && value && Object.keys(actor_model_1.getDefaultActor()).includes(key.trim())) {
...
var updateActor = function (actor) { return __awaiter(void 0, void 0, void 0, function () {
    var query, result;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                query = lib_sqlUtils_1.generateUpdateQuery("public.\"actor\"", actor_model_1.getDefaultActor(), actor, true);
...
var removeActor = function (actor) { return __awaiter(void 0, void 0, void 0, function () {
    var query, result;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                query = lib_sqlUtils_1.generateDeleteQuery("public.\"actor\"", { id: actor.id });
                return [4 /*yield*/, pg.db.query(query.text, query.values)];
            case 1:
                result = (_a.sent()).rows[0];
                return [2 /*return*/, result];
...
var createActor = function (actor) { return __awaiter(void 0, void 0, void 0, function () {
    var query, result;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                query = lib_sqlUtils_1.generateInsertQuery("public.\"actor\"", actor_model_1.getDefaultActor(), actor, true, true);
                return [4 /*yield*/, pg.db.query(query.text, query.values)];
            case 1:
                result = (_a.sent()).rows[0];
                return [2 /*return*/, result];
